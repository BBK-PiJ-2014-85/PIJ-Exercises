...
public class BinaryTreeNode {
	...
	public BinaryTreeNode(String input) {value = input;}
	...
	public static BinaryTreeNode toTree(String input)
	{
		...
		if (hasBracket)
		{
			...
			for (int i=0; i < input.length(); i++)
			{
				...
				if (lastBracket == -1 && input.charAt(input.length() - 1 - i) == ')') lastBracket = input.length() - 1 - i;
			}
	...
	public void setLeft(BinaryTreeNode input) {left =input;}
	public void setRight(BinaryTreeNode input) {right =input;}
